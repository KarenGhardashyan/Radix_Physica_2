...
public class GraphActivity extends AppCompatActivity {
    ...
    private TextInputLayout xValueLayout, yValueLayout;
    private TextInputEditText xValueEditText, yValueEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xValueLayout = findViewById(R.id.xValue);
        yValueLayout = findViewById(R.id.yValue);

        xValueEditText = findViewById(R.id.xedittext);
        yValueEditText = findViewById(R.id.yedittext);
    ...
    private void addPoint() {
        String xText = xValueEditText.getText().toString();
        String yText = yValueEditText.getText().toString();

        try {
            float xValue = Float.parseFloat(xText);
            float yValue = Float.parseFloat(yText);
